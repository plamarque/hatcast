...
ARG HATCAST_FIREBASE_WEB_API_KEY
ARG HATCAST_FIREBASE_AUTH_DOMAIN
ARG HATCAST_FIREBASE_PROJECT_ID
ARG HATCAST_WEB_PUSH_VAPID_PUBLIC_KEY
ARG HATCAST_POSTHOG_PROJECT_API_KEY
ENV GOOGLE_OAUTH_WEB_CLIENT_ID=${GOOGLE_OAUTH_WEB_CLIENT_ID}
ENV HATCAST_FIREBASE_WEB_API_KEY=${HATCAST_FIREBASE_WEB_API_KEY}
ENV HATCAST_FIREBASE_AUTH_DOMAIN=${HATCAST_FIREBASE_AUTH_DOMAIN}
