...
**Avant M4 (PO 2026-06-05) :** **OPS-10** [x] staging 2026-06-05 + prod reset MDP 2026-06-19. **OPS-9** [x] (`sprint-status.yaml`). **11.2** identify `email` + `name` sur People PostHog (cutover La Malice ~30 membres).
