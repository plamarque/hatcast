...
describe('AuthRedirect', () => {
  it('redirige vers la connexion sans session', async () => {
    ...
    const fixture: ComponentFixture<AuthRedirect> = TestBed.createComponent(AuthRedirect)
  ...
  it('utilise la navigation post-connexion quand la session est valide', async () => {
    const navigate = vi.fn().mockResolvedValue(true)
