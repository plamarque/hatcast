...
Styles onglet **Équipe** (grille, lignes, déclins) : partial global `styles/_hatcast-equipe-composition.scss` (importé dans `styles.scss`) — hors budget `anyComponentStyle` du composant `event-equipe-tab`.
