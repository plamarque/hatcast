...
- [x] [Review][Defer] Migration V38 sans backfill des rows REMOVED préexistantes (`removal_source` NULL) — probablement aucune row membre concernée en pratique; à vérifier avant prod. [services/api/src/main/resources/db/migration/V38__season_participant_removal_source.sql] — deferred, pre-existing
