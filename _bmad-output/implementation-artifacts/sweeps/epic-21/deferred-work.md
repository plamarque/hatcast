# Deferred Work — Scoped sweep: Epic 21

scope: Epic 21 delivery follow-through only
source_ledger: `_bmad-output/implementation-artifacts/deferred-work.md`
selected_ids: DW-126, DW-127, DW-128
selection_rule: Do not add, close, or execute any entry outside `selected_ids` in this scoped sweep.
