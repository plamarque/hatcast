...
8. **Given** story completion, **when** UX doc is updated, **then** [`ux-design-hatcast-v2.md`](../planning-artifacts/ux-design-hatcast-v2.md) § [Primary controls](#screen-event-detail-equipe-tab) references this matrix, overflow for **Partager**, and **M3 filled/outlined** (not V1 rainbow gradients per button).
